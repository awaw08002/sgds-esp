      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-12">
        <div className="mb-8">
          <Link href="/etudiant/dashboard"
            className="text-[#64748B] hover:text-[#1E3A5F] text-sm font-medium transition-colors flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                placeholder="Decrivez les objectifs et les missions prevues durant votre stage..."
                required />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <div className="border-2 border-dashed border-slate-200 rounded-xl p-6 text-center">
                ...
                <label htmlFor="files" className="cursor-pointer">
                  ...
                  <span className="text-[#F59E0B] font-semibold text-sm hover:text-[#D97706]">
