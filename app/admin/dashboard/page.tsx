              ...
              <div className="bg-white rounded-2xl shadow-md border border-slate-100 p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="password" className="input-field" value={newUser.password} onChange={e => setNewUser(p=>({...p,password:e.target.value}))} placeholder="Minimum 8 caracteres" required />
                  </div>
                  <div>
